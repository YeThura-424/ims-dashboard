...
watch(
  ...
  (currentVendor) => {
    vendorForm.name = currentVendor.data.vendor_name;
    vendorForm.code = currentVendor.data.vendor_code;
    vendorForm.type = currentVendor.data.vendor_type;
    vendorForm.status = currentVendor.data.vendor_is_active;
    vendorForm.paymenttype = currentVendor.data.vendor_payment_type;
    vendorForm.id = currentVendor.data.vendor_id;
  }
);
